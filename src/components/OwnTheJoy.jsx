...
const OwnTheJoy = () => {
  return (
    <section className="bg_cream position-relative">
      <img src={Flower} className="position-absolute end-0 top_10 d-none d-xl-block" alt="flower" />
      <Container className="py-5">
        <Row className="py-sm-5 my-md-5">
        ...
        <Row className="align-items-center justify-content-center py-sm-5 flex-column-reverse flex-lg-row">
          <Col xsm={12} lg={5}>
