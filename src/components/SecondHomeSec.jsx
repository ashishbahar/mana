...
const SecondHomeSec = () => {
  return (
    <section className="bg_cream">
      <Container>
        <div className="text-center pt-5 pb-sm-5 ">
          <h2 className="ff_timenew_roman mt-sm-5 fw_700 fs_4xl color_darkgreen">
        ...
        <Row className="py-5 justify-content-center">
          <Col lg={4} md={6}  >
            <div className="d-flex  align-item-center">
              <div>
                <img src={heartlock} className="mt-2 me-3" alt="heartlock" />
              </div>
              <div>
          ...
          <Col lg={4} md={6} >
            ...
            <div className="d-flex mt-3 mt-md-0 align-item-center">
              <div>
                <img src={own} className="mt-2 me-3" alt="heartlock" />
              </div>
              <div>
                <p className=" m-0 ff_timenew_roman  fw_700 fs_2xl color_darkgreen ">
                  Own
          ...
          <Col lg={4} md={6} >
            ...
            <div className="d-flex mt-3 mt-lg-0 align-item-center">
              <div>
                <img src={lotus} className="mt-2 me-3 max_width_33" alt="heartlock" />
              </div>
              <div>
                <p className=" m-0 ff_timenew_roman  fw_700 fs_2xl color_darkgreen ">
                  Enjoy
