...
const Email = () => {
  return (
    <section className="bg_cream position-relative">
      <img
        className="position-absolute leaf_position d_none "
        src={leaf}
        alt="leaf"
      />
      <img
      ...
      />
      <Container>
        <div className="text-center pb-3 py-sm-5">
          ...
          <div>
            <div className="max_width_530 m-auto my-5 ">
              ...
              <div className="d-sm-flex justify-content-center justify-content-md-start">
                ...
                <div className="d-flex ms-sm-4 justify-content-center mt-4 mt-sm-0 justify-content-sm-start">
                ...
                <div className="d-flex ms-sm-4 mt-4 mt-sm-0 justify-content-center justify-content-sm-start">
